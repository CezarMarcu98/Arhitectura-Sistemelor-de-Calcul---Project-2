...
EXTRA_OPT_CFLAGS=-fno-math-errno -funsafe-math-optimizations -ffinite-math-only -fno-rounding-math -fno-signaling-nans -fcx-limited-range -fexcess-precision=fast -frerun-cse-after-loop -fweb -frename-registers
